...
/**
 * Recommended [BatmanRouter] timing parameters for a given link speed.
 *
 ...
 * - The returned [RouterConfig.ogmInterval] is floored at 50 ms — below that,
 *   scheduling jitter dominates and the interval loses meaning.
 *
...
fun recommendedConfig(
    ...
    val ogmInterval       = intervalSeconds.seconds.coerceAtLeast(50.milliseconds)
